...
//return dirname($file);  // Commented by Ritesh 

$path = explode('public',dirname($file));
return $path[0].'public_html/public/min';  
}
...
$filesToMinify = array_merge($filesToMinify, $this->getFilesFromString($files));	
}
