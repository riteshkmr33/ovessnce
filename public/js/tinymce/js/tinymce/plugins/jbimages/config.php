...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'js/tinymce/images/'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	
	$config['upload_path'] = "/home/homepath/public_html/" . $config['img_path']; // Physical path. [Usually works fine like this]
