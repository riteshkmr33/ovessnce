...
function getDataForList() {
    ...
    } else if (address.length > 0 && address[0] != "") {
        alert("After entering your zip code or your city, please select the desired zip code and city among the suggestions that are displayed");
        return false;
    }
