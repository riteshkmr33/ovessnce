...
(function($){
    $.fn.autoComplete = function(options){
        var o = $.extend({ source: null, minChars: 3, delay: 100, cache: true, onChange: function(term){}, onSelect: function(term){}, onGenerate: function(data, i, re){return '<div class="autocomplete-suggestion" data-val="'+data[i]+'">'+data[i].replace(re, "<b>$1</b>")+'</div>';} }, options);
        ...
        return this.each(function(){
            ...
            that.sb.on('mousedown.autocomplete', '.autocomplete-suggestion', function (){
                var v = $(this).data('val');
                that.val(v);
                o.onSelect($(this).data());  // o.onSelect(v);  changed by developer
            ...
            that.on('keydown.autocomplete', function(e){
                ...
                if (e.which == 40) {
                    ...
                    if (!sel.length) {
                        ...
                        o.onChange(next.addClass('selected').data());  // added by developer
                    } else {
