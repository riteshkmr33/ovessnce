...
define('DB_HOST', '192.168.2.129'); // Database host ## Datenbank Server
define('DB_PORT', 3306); // Enter the database port for your mysql server
define('DB_USER', 'clavax'); // Database user ## Datenbank Benutzername
...
// Important Stuff
define('LS_SUPEROPERATOR', '1'); // Undeletable and SuperADMIN User, more user seperate with comma. e.g. 1,4,5,6 (userid)
?>
