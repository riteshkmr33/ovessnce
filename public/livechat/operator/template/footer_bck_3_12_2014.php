...
<footer>Copyright <?=date('Y');?> by <a href="http://www.livesupportrhino.com">Rhino Socket</a><?php if (LS_SUPERADMINACCESS) echo ' ('.$tl['general']['g118'].LS_VERSION.')';?><?php if ($LS_PROVED) { ?> | <a href="index.php?p=logout" onclick="if(!confirm('<?php echo $tl["logout"]["l2"];?>'))return false;"><?php echo $tl["logout"]["l"];?></a><?php } ?></footer>
