...
<footer>Copyright <?=date('Y');?> by <a href="http://www.livesupportrhino.com">Live Chat Ovessence</a><?php if (LS_SUPERADMINACCESS) echo ' ('.$tl['general']['g118'].LS_VERSION.')';?></footer>
